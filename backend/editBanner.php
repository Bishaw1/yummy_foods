            ...
            <input type="hidden" name="id" value="<?=$id?>">
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        ?>
                        <br>
                        <img src="../uploads/<?=$banner["banner_img"]?>" class="display" alt="" width="100%">

                    </div>
                    
                    <div class="col-lg-8">
                        <input type="text" class="form-control" placeholder="Title" name="title" value="<?=$banner["title"]?>">
                        <textarea name="description" cols="30" rows="10" class="form-control my-2" placeholder="Description"><?=$banner["detail"]?></textarea>
